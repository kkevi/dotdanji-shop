...
export const FAKE_NOTICE_DATA: NoticeType[] = [
    {
        ...
        title: "돛단지몰이 오픈했습니다!",
        content:
            "<p>안녕하세요. 어린이들을 위한 즐거운 한글 콘텐츠를 만드는 돛단지입니다.<br/> 좋은 상품과 서비스로 찾아뵙겠습니다.<br/> 많은 기대 부탁드립니다! 감사합니다.</p>",
        date: "2022-06-01",
    },
    {
        ...
        content:
            "<p>안녕하세요 돛단지입니다.<br/> 똑똑하고 흥미로운 언어교육, 돛단지가 출시되었습니다!<br/> 돛단지에 대한 자세한 사항은 상품 페이지를 확인해주세요. 감사합니다.</p>",
        date: "2022-06-01",
    },
]
...
export const FAKE_FAQ_DATA: FaqDataType[] = [
    {
        ...
        title: "회원가입이 안 돼요.",
        content:
            "회원가입 시, 불편함이 있으셨나요? dotdanji@simbaat.com 이메일로 문제되는 화면 캡쳐와 내용을 보내주세요.",
    },
    {
        category: "pay",
