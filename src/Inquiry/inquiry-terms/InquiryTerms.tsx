...
export default function InquiryTerms({formData, setFormData, mobile}: InquiryTermsProps) {
    return (
        <Stack>
            ...
            <FormControlLabel
                ...
                label={<Typography fontSize={mobile ? 12 : 14}>개인정보 수집 및 이용에 동의합니다.</Typography>}
            />
        </Stack>
    )
}
