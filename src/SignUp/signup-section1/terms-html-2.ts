export const terms2 = `<div>
    <h1>개인정보처리방침</h1>
    <br />
    <h2>제1조(목적)</h2>
    <p>
        주식회사 심바트(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하
    ...
    <p>1. 회사가 운영하는 인터넷 홈페이지의 첫 화면의 공지사항란 또는 별도의 창을 통하여 공지하는 방법</p>
    <p>2. 서면·모사전송·전자우편 또는 이와 비슷한 방법으로 이용자에게 공지하는 방법</p>
    <p>
    ...
    <p>1. 필수 수집 정보: 이메일 주소, 비밀번호, 이름, 닉네임, 생년월일 및 휴대폰 번호</p>
    <br /><br />
    <h2>제6조(본인 인증을 위한 정보)</h2>
    <p>회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.</p>
    <p>
        1. 필수 수집 정보: 휴대폰 번호, 이메일 주소, 이름, 생년월일, 성별, 본인확인값(CI,DI), 이동통신사, 아이핀
        정보(아이핀 확인 시) 및 내/외국인 여부
    </p>
    <br />
    <h2>제7조(법정대리인 동의를 위한 정보)</h2>
    <p>회사는 법정대리인의 동의가 필요한 경우 법정대리인의 동의를 위하여 다음과 같은 정보를 수집합니다.</p>
    <p>
        1. 필수 수집 정보: 보호자 이름, 보호자 생년월일, 보호자 성별, 보호자 내/외국인 여부, 보호자 휴대폰 번호, 보호자
        이동통신사 정보, 보호자 아이핀 정보(아이핀 확인 시) 및 보호자 본인확인값(CI,DI)
    </p>
    <br /><br />
    <h2>제8조(결제 서비스를 위한 정보)</h2>
    <p>회사는 이용자에게 회사의 결제 서비스 제공을 위하여 다음과 같은 정보를 수집합니다.</p>
    <p>1. 필수 수집 정보: 카드번호, 카드비밀번호, 유효기간, 생년월일 6자리(yy/mm/dd), 은행명 및 계좌번호</p>
    <br /><br />
    <h2>제9조(현금 영수증 발행을 위한 정보)</h2>
    <p>회사는 이용자의 현금영수증을 발행하기 위하여 다음과 같은 정보를 수집합니다.</p>
    <p>
        1. 필수 수집 정보: 현금영수증 발행 대상자 이름, 현금영수증 발행 대상자 생년월일, 현금영수증 발행 대상자 주소,
        휴대폰 번호 및 현금영수증 카드번호
    </p>
    <br />
    <h2></h2>
    ...
    <p>1. 필수 수집 정보: 아이디, 이메일 주소, 이름, 생년월일 및 연락처</p>
    <br /><br />
    <h2>제11조(서비스 이용 및 부정 이용 확인을 위한 정보)</h2>
    <p>회사는 이용자의 서비스 이용 및 부정이용의 확인 및 분석을 위하여 다음과 같은 정보를 수집합니다.</p>
    <p>1. 필수 수집 정보: 서비스 이용기록, 쿠키, 접속지 정보 및 기기정보</p>
    <br />
    <p>
        ※ 부정이용 : 회원탈퇴 후 재가입, 상품구매 후 구매취소 등을 반복적으로 행하는 등 회사가 제공하는 할인쿠폰, 이벤트
        혜택 등의 경제상 이익을 불·편법적으로 수취하는 행위, 이용약관 등에서 금지하고 있는 행위, 명의도용 등의
    ...
    <p>2. 이용자가 고객센터의 상담, 게시판에서의 활동 등 회사의 서비스를 이용하는 과정에서 이용자가 입력하는 방식</p>
    <br /><br />
    <h2>제13조(개인정보의 이용)</h2>
    ...
    <p>4. 신규 서비스 개발을 위한 경우</p>
    <p>5. 이벤트 및 행사 안내 등 마케팅을 위한 경우</p>
    <p>6. 인구통계학적 분석, 서비스 방문 및 이용기록의 분석을 위한 경우</p>
    <p>7. 개인정보 및 관심에 기반한 이용자간 관계의 형성을 위한 경우</p>
    <p>
        8. 법령 및 회사 약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에
        지장을 주는 행위에 대한 방지 및 제재를 위한 경우
    </p>
    <br /><br />
    <h2>제14조(사전동의 등에 따른 개인정보의 제공)</h2>
    <p>
        ① 회사는 개인정보 제3자 제공 금지에도 불구하고, 이용자가 사전에 공개하거나 다음 각호 사항에 대하여 동의한
        경우에는 제3자에게 개인정보를 제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서 최소한으로 개인정보를
        제공합니다.
    </p>
    <p>
        가. 아임포트에게 서비스 이용시 결제 대행사를 통한 결재을 위하여 회원가입, 서비스 이용을 위해 수집한 정보을 제공
    </p>
    <p>
        나. 카카오페이에게 서비스 이용시 결제 대행사를 통한 결재을 위하여 회원가입, 서비스 이용을 위해 수집한 정보을
        제공
    </p>
    <p>
        다. 토스페이먼츠에게 서비스 이용시 결제 대행사를 통한 결재을 위하여 회원가입, 서비스 이용을 위해 수집한 정보을
        제공
    </p>
    <br />
    ② 회사는 전항의 제3자 제공 관계에 변화가 있거나 제3자 제공 관계가 종결될 때도 같은 절차에 의해 이용자에게 고지 및
    동의를 구합니다.
    <br /><br />
    ...
    <br /><br />
    <h2>제18조(서비스 미이용자에 대한 개인정보처리)</h2>
    <p>
    ...
    <p>1. 회사명 및 연락처</p>
    <p>2. 수신 거부 또는 수신 동의의 철회 의사표시에 관한 사항의 표시</p>
    <p>
        ⑤ 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음 각 호의 어느 하나에 해당하는
        조치를 하지 않습니다.
    </p>
    <p>1. 광고성 정보 수신자의 수신거부 또는 수신동의의 철회를 회피·방해하는 조치</p>
    <p>2. 숫자·부호 또는 문자를 조합하여 전화번호·전자우편주소 등 수신자의 연락처를 자동으로 만들어 내는 조치</p>
    <p>3. 영리목적의 광고성 정보를 전송할 목적으로 전화번호 또는 전자우편주소를 자동으로 등록하는 조치</p>
    <p>4. 광고성 정보 전송자의 신원이나 광고 전송 출처를 감추기 위한 각종 조치</p>
    <p>5. 영리목적의 광고성 정보를 전송할 목적으로 수신자를 기망하여 회신을 유도하는 각종 조치</p>
    <br /><br />
    <h2>제22조(아동의 개인정보보호)</h2>
    <p>① 회사는 만 14세 미만 아동의 개인정보 보호를 위하여 만 14세 이상의 이용자에 한하여 회원가입을 허용합니다.</p>
    <p>
        ② 제1항에도 불구하고 회사는 이용자가 만 14세 미만의 아동일 경우에는, 그 아동의 법정대리인으로부터 그 아동의
    ...
    <p>③ 회사는 만일의 사태에 대비하여 침입차단 시스템을 이용하여 보안에 최선을 다하고 있습니다.</p>
    <p>
        ④ 회사는 민감한 개인정보(를 수집 및 보유하고 있는 경우)를 암호화 통신 등을 통하여 네트워크상에서 개인정보를
        안전하게 전송할 수 있도록 하고 있습니다.
    </p>
    <br /><br />
    <h2>제30조(개인정보 처리 최소화 및 교육)</h2>
    <p>
        회사는 개인정보 관련 처리 담당자를 최소한으로 제한하며, 개인정보 처리자에 대한 교육 등 관리적 조치를 통해 법령
        및 내부방침 등의 준수를 강조하고 있습니다.
    </p>
    <br /><br />
    <h2>제31조(개인정보 유출 등에 대한 조치)</h2>
    <p>
    ...
    <br /><br />
    <h2>제34조(쿠키 설치 허용 지정 방법)</h2>
    <p>쿠키 설치 허용 여부를 지정하는 방법(Internet Explorer의 경우)은 다음과 같습니다.</p>
    <p>가. [도구] 메뉴에서 [인터넷 옵션]을 선택합니다.</p>
    <p>나. [개인정보 탭]을 클릭합니다.</p>
    <p>다. [고급] 설정에서 설정하시면 됩니다.</p>
    <br /><br />
    <h2>제35조(회사의 개인정보 보호 책임자 지정)</h2>
    <p>
        ① 회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보
        보호 책임자를 지정하고 있습니다.
    </p>
    <p>가. 개인정보 보호 책임자</p>
    <p>- 성명: 오홍석</p>
    <p>- 이메일: contact@simbaat.com</p>
    <br />
    <p>부칙</p>
